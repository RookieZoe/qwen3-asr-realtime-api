...
# 私有后端服务地址 (修改为你的服务地址)
DEFAULT_WS_URL = "ws://localhost:8001/api-ws/v1/realtime"
...
示例:
  # VAD 模式 (实时录音)
  python demo_sdk.py --mode vad --url ws://localhost:8001/api-ws/v1/realtime
  
  # Manual 模式 (音频文件)
  python demo_sdk.py --mode manual --file test.wav --url ws://localhost:8001/api-ws/v1/realtime
  ...
  python demo_sdk.py --mode manual --file test.wav --language zh
    ...
    parser.add_argument(
        ...
        help=f'WebSocket 服务地址 (默认: {DEFAULT_WS_URL})'
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help='音频发送间隔, 秒 (默认: 0.1)'
    )
    
    parser.add_argument(
        '--api-key', '-k',
        default=DEFAULT_API_KEY,
        help='API Key (本地服务可随意填写)'
    )
